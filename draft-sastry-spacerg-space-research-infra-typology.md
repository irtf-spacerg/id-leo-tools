...
Rather than classifying resources according to implementation technology or project origin, the proposed taxonomy groups resources according to their research function.
...
The typology described in this document was developed through an analysis of the more than 110 verified research resources collected from the community and curated in the SPACERG registry.
Rather than deriving categories from software architecture or implementation language, the classification emerged from the primary research purpose served by each resource.
...
The purpose of this document is therefore not to prescribe a fixed ontology, but rather to establish a common vocabulary that enables researchers to consistently classify and discover research infrastructures relevant to space networking.
